 ...
 * @author Andrew
 */
public class FastDrinker  extends Observable implements Runnable,interfaces.DrinkerInterface{
    protected final int drinkamount = 5;
    private int amountofdrink;
    private int timeatbare;
    private boolean stilldrinking = true;
    private String response= "more drink";
    public FastDrinker(int amountofdrink, int timeatbare) {
